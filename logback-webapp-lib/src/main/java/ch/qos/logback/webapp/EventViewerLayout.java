...
public class EventViewerLayout
		extends ContextAwareBase
		implements
			Layout<ILoggingEvent>
{
	public EventViewerLayout ()
	{
		super ();
	...
	{
		final EventViewerLayout layout = new EventViewerLayout ();
		...
		layout.start ();
		System.out.println (layout.getPresentationHeader ());
		System.out.print (layout.doHeaderLayout ());
		System.out.println (layout.doLayout (new LoggingEvent ("class", logger, Level.INFO, "message", null, null)));
		System.out.println (layout
				.doLayout (new LoggingEvent ("class", logger, Level.INFO, "message", new Throwable (), null)));
		System.out.println (layout.doLayout (new LoggingEvent ("class", logger, Level.INFO, "message", new Throwable (
				new Throwable ()), null)));
		System.out.println (layout.getPresentationFooter ());
	}
