...
public final class AmqpConsumerSource
		extends AmqpAccessorWrapper<AmqpConsumer>
		implements
			LoggingEventSource
{
	public AmqpConsumerSource (
			final AmqpConsumer accessor, final LoggingEventMutator mutator, final Serializer serializer,
